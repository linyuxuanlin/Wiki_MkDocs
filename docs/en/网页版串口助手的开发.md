...
This project is built upon [**web-serial-terminal**](https://github.com/rafaelaroca/web-serial-terminal) and adds [**debugout.js**](https://github.com/inorganik/debugout.js) to implement logging and exporting functionalities. The following are the detailed steps:
...
- [How to read and write txt files in JavaScript? (Alternative approach)](https://www.cnblogs.com/simuhunluo/p/8109429.html)
- [Finally found you! How to save console.log logs in a file in frontend?](https://segmentfault.com/a/1190000009426931)
