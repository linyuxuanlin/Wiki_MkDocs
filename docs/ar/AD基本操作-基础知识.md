...
Before starting to design a PCB, it is essential to familiarize ourselves with some basic knowledge of Altium Designer and circuit design.

## Library Installation

A library is a collection of schematic/PCB footprints for each discrete component (such as resistors, capacitors, etc.) that can be easily accessed. It is not necessary to create a schematic/footprint library for every component, but **organizing your own library is a must**. Imagine that every component in your project is from someone else's library (and different libraries have their own rules), then you will be more and more restricted. Having your own library not only facilitates migration and improves efficiency, but also benefits the systematization of knowledge. With your own rules and system, knowledge will grow exponentially over time. Although the growth curve is slow at the beginning, there will be no repetitive work in the later stage. All you need to do is learn new knowledge and incorporate it into the system.

Friendly reminder: Try to extract all the components needed for your project from your own schematic/footprint library.

### Reference Libraries

- [**Power_Lib_Altium**](https://github.com/linyuxuanlin/Power_Lib_Altium): A library I organized myself. The footprint library is complete, and the schematic library only includes the component models required for my project. It is constantly updated.
...
- [**JLCSMT_LIB**](https://gitee.com/JLC_SMT/JLCSMT_LIB): A standard integrated library provided by Jia Li Chuang, including all components that can be SMT pasted by Jia Li Chuang. Using this integrated library will have better compatibility when making PCBs/SMT.
- [**Hare_Library**](https://github.com/linyuxuanlin/Power_Lib_Altium/tree/master/Other_Libs/Hare_Library): A schematic/footprint library organized by Bin Ge, covering most of the components required by the team.
...
- ترقيم المكونات تلقائيًا: **TAA**
  ...
  - قبول التغييرات (إنشاء ECO): تعني قبول تغييرات الترقيم وتنفيذها في الرسم البياني الأصلي
- إنشاء جدول BOM: **RI**
- تحديث PCB: **DU**
...
- وضع المكونات على الطبقة السفلية: **اسحب بالضغط على L**
- تخطيط تلقائي: **تحديد مربع + TOL**
...
- عكس الاتجاه الأفقي: **Ctrl + F**
- القياس: **Ctrl + M**
- تبديل العرض (2D / 3D): **2/3**
- تدوير في العرض ثلاثي الأبعاد: **اضغط Shift + اسحب**
- مسح المرشح: **Shift + C**
- تبديل العرض الأحادي / المتعدد: **Shift + S**
- غطاء الثقب (يمكن تجاهله ، يمكن اختياره مباشرة عند الطباعة)
  1. انقر فوق ثقب معين
  2. انقر بزر الماوس الأيمن - البحث عن كائنات مماثلة
  3. حدد خاصية الحجم كـ Same ، واضغط على موافق لتنشيط تحديد جميع الثقوب
  4. في توسيع ماسك اللحام في الخصائص ، حدد الطبقة العلوية والطبقة السفلية
- تعيين قواعد التوصيل
  1. **UAA**
  2. إنشاء استراتيجية وتحرير القواعد
  3. تعديل القواعد في Routing (إنشاء قواعد جديدة)
     - العرض: تعيين سمك الخط
     - توصيل عبر الفتحة: تعيين قواعد الفتحة
     - النحاس:؟
...
3. رسم PCB
   ...
   2. إخفاء علامات Designator للعناصر
      1. فتح لوحة Properties من اليمين
      2. النقر على الرمز الذي يشبه العين بجوار Designator لإغلاقه
   3. رسم شكل اللوحة
      - تبديل خطوط الربط بزاوية 90°/45° (Shift+Space)
      - تعريف اللوحة بالشكل المرسوم (DSD)
      - تعيين خصائص إطار اللوحة على Mechanical Layer 1
      - إضافة ثقوب ثابتة
        - ثقوب M3: قطر داخلي 3.1 ملم، قطر خارجي 4 ملم
   4. ترتيب العناصر
      - انتقل إلى المقالة [PCB قواعد ترتيب العناصر](](https://wiki-power.com/ar/PCB%E5%85%83%E4%BB%B6%E5%B8%83%E5%B1%80%E8%A7%84%E8%8C%83)
   5. توصيل العناصر
      - تعيين قواعد التوصيل
        - الرجوع إلى [PCB قواعد توصيل العناصر](](https://wiki-power.com/ar/PCB%E5%B8%83%E7%BA%BF%E8%A7%84%E8%8C%83)
      - عدم تفعيل التوصيل التلقائي!
      - تفعيل خاصية البقعة الدمعية
   6. تسمية الخطوط (تسمية الأقطاب / حقوق النشر / النصوص المضللة)
      - وضعها على طبقة الطباعة (الطبقة العلوية / الطبقة السفلية)
      - إذا تم وضعها على الطبقة السفلية، يجب تعكسها أولاً
   7. توصيل النحاس (PG)
      - الرجوع إلى [PCB قواعد توصيل العناصر](](https://wiki-power.com/ar/PCB%E5%B8%83%E7%BA%BF%E8%A7%84%E8%8C%83)
4. تصنيع اللوحة
   1. حفظ المشروع
   2. ضغط ملف .pcb (إذا كان ذلك ممكنًا، يمكن تصدير Gerber)
   3. تحميله على مساعد الطلب الخاص بـ JLCPCB
   4. (اختياري SMT)
...
- Designator: رمز العنصر، وهو العلامة المميزة للعنصر والتي تستخدم لتحديد العناصر المختلفة في المخطط
  - R: المقاومة
  - RN: المقاومة المتسلسلة
  - C: التكثيف
  - J: الواجهة / الأسلاك القاطعة
  - X: الكريستال
  - D: الثنائي
  - Q أو T: الثلاثي
  - FB: الخرز المغناطيسي
  - U: الشريحة
  - TP: نقطة الاختبار
- Comment: معلمات الحجم للعنصر، مثل قيمة المقاومة وسعة التكثيف ونوع الشريحة IC وما إلى ذلك
...
- [جياليتشوانج SMT قائمة اللصق القابلة للتطبيق PADS مكتبة متكاملة (الإصدار الرسمي)](http://club.szlcsc.com/article/details_2757_1.html)
