...
![](https://img.wiki-power.com/d/wiki-media/img/20190509034209667.png)

## 开箱

拆开快递包裹，出现了一个 DFRobot 专属橙色的盒子：

![](https://img.wiki-power.com/d/wiki-media/img/IMG_0291.jpg)

打开盒盖，可以发现 micro:bit 主板和麦昆套件：

![](https://img.wiki-power.com/d/wiki-media/img/IMG_0293.jpg)

![](https://img.wiki-power.com/d/wiki-media/img/IMG_0294.jpg)

零件全家福：

![](https://img.wiki-power.com/d/wiki-media/img/IMG_0296.jpg)

小车装好后的样子：

![](https://img.wiki-power.com/d/wiki-media/img/IMG_0305.JPG)
...
![](https://img.wiki-power.com/d/wiki-media/img/IMG_0306.JPG)
...
我编写了一个程序，用于测试电机能否正常运行： ![](https://img.wiki-power.com/d/wiki-media/img/20190509173944.png) 其中，「无限循环」代码块相当于 Arduino 下的 loop\(\) 函数。

点击下载按钮，下载一个 .hex 后缀的文件，将 micro:bit 连接计算机并当做一个储存设备，把文件直接丢进去就自动上传了。 ![](https://img.wiki-power.com/d/wiki-media/img/20190509053649722.png)
