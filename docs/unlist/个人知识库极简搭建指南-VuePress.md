...
![](https://img.wiki-power.com/d/wiki-media/img/20201122232933.jpg)

接下来提示 `Please select the directory（请选择目录）` ，直接点 `Continue` 继续就行。

在接下来的页面，我们只需在 `OUTPUT DIRECTORY（输出目录）` 处，填入 `docs/.vuepress/dist` 即可：

![](https://img.wiki-power.com/d/wiki-media/img/20201122235715.jpg)
...
![](https://img.wiki-power.com/d/wiki-media/img/20201122232843.jpg)
...
![](https://img.wiki-power.com/d/wiki-media/img/20201122233838.jpg)
