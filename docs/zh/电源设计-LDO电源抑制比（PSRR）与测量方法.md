...
![](https://media.wiki-power.com/img/20220516174303.png)
...
![](https://media.wiki-power.com/img/20220421142140.png)

可以看出，在频率为 1kHz 时，XC6206P302 的纹波抑制比约为 23dB。

再看高速 LDO（XC6217x302）的纹波抑制曲线：

![](https://media.wiki-power.com/img/20220421141923.png)

在频率为 1kHz 时，XC6217x302 的纹波抑制比约为 68dB。

## 电源抑制比（PSRR）的测量方法

![](https://media.wiki-power.com/img/20220424104353.png)
...
![](https://media.wiki-power.com/img/20220424101211.png)

其中，R1 与 R2 相等，最低截止频率由 C1 和 R1 共同决定，最高截止频率由运放的带宽所决定。

![](https://media.wiki-power.com/img/20220424104709.png)
