...
| ---------------- | ------ | -------------------- | ----------------------------- | ----------------------------- |
| **backup**       | ⭐     |                      |                               |                               |
| **book**         | ⭐⭐   | multi_encrypt-upload |                               |                               |
| **docker**       | ⭐⭐⭐ | multi_encrypt-upload | multi_encrypt-upload-schedule | multi_encrypt-upload-schedule |
| **music**        | ⭐     |                      |                               |                               |
| **photo**        | ⭐⭐⭐ | multi_encrypt-upload |                               |                               |
| **projects**     | ⭐     |                      |                               |                               |
| **stash**        | ⭐⭐   |                      |                               |                               |
| **video**        | ⭐⭐   |                      |                               |                               |
| **web**          | ⭐     |                      |                               |                               |
| **web_packages** | ⭐     |                      |                               |                               |
| **wiki-media**   | ⭐⭐⭐ | multi_encrypt-upload | multi_encrypt-upload-schedule | wiki-media_upload-schedule    |
| **win-desktop**  | ⭐⭐⭐ | multi_encrypt-upload | multi_encrypt-upload-schedule | multi_encrypt-upload-schedule |
| **win-software** | ⭐⭐⭐ | multi_encrypt-upload | multi_encrypt-upload-schedule | multi_encrypt-upload-schedule |
