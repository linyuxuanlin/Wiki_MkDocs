...
openai.api_base = os.environ.get("URL_OPENAI_FAKE")
#openai.api_base = os.environ.get("URL_OPENAI")

#openai.api_key = os.environ.get("KEY_CHATANYWHERE_IRIS")
#openai.api_key = os.environ.get("KEY_CHATANYWHERE_ME")
openai.api_key = os.environ.get("KEY_OPENAI_FAKE_LINYUXUANLIN52")
#openai.api_key = os.environ.get("KEY_OPENAI_FAKE_LISU")
#openai.api_key = os.environ.get("KEY_OPENAI_LINYUXUANLIN52")
